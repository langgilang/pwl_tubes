          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-sm-12">
                      <a href="/datasiswa/add" class="btn btn-success">
                          <i class="fa fa-plus" aria-hidden="true" style="color: white"></i>
                      </a>
                      <a href="/datasiswa/cetak_pdf" class="btn btn-warning" target="_blank">
                  ...
                  <tbody>
                    ...
                    @foreach ($siswa as $a)
                      <tr>
                        ...
                        <td align="center">
                          <img width="150px" src="{{ asset('storage/'.$a->image)}}">
                        </td>
                        <td>{{ $a->NIM }}</td>
                        <td>{{ $a->nama }}</td>
                        <td>{{ $a->kelas }}</td>
                        ...
                        <td class="project-actions text-center">
                          <a href="/datasiswa/edit/{{ $a->id }}" class="btn btn-info">
                              <i class="fas fa-pencil-alt"></i>
                          </a>
                          <a href="/datasiswa/delete/{{ $a->id }}" class="btn btn-danger">
